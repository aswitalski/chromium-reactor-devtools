// console.log('Reactor:', window, document.body, window.Reactor);
{
...
// Reactor.connectDevTools(() => {
//   console.log('Connectedto DevTools');
//   // chrome.extension.sendMessage({action: 'message', content: "Reactor"}, function(message){});
// });